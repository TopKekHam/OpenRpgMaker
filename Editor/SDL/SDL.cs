...
public unsafe class SDLMemoryOps
{
    ...
    public unsafe void* Malloc(ulong size)
    {
        return _malloc(size);
    }

    public unsafe void* Realloc(void* ptr, ulong new_size)
    {
...
public static class SDL
{
    ...
    const string dll_name = "SDL2.dll";
    ...
    public unsafe static string CStrToString(byte* bytes, int length)
    {
        return System.Text.Encoding.ASCII.GetString(bytes, length);
    }

    public unsafe static int CStrLen(byte* bytes)
    {
        int idx = 0;
    ...
    public unsafe static string CStrToString(byte* bytes)
    {
        return CStrToString(bytes, CStrLen(bytes));
    }

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern void SDL_GetMemoryFunctions(void** malloc_func, void** calloc_func, void** realloc_func, void** free_func);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern SDL_RWops* SDL_memset(void* ptr, int value, ulong size);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern SDL_RWops* SDL_RWFromMem(void* mem, int size);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern SDL_AudioSpec* SDL_LoadWAV_RW(SDL_RWops* src, int freesrc, SDL_AudioSpec* spec, byte** audio_buf, uint* audio_len);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern SDL_AudioSpec* SDL_LoadWAV([MarshalAs(UnmanagedType.LPStr)] string file, SDL_AudioSpec* spec, byte** audio_buf, uint* audio_len);
    ...
    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public unsafe static extern SDL_Surface* SDL_GetWindowSurface(IntPtr window_handle);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_UpdateWindowSurface(IntPtr window_handle);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe void* SDL_GL_GetProcAddress([MarshalAs(UnmanagedType.LPStr)] string proc_name);
    ...
    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static extern unsafe byte* SDL_GetWindowTitle(IntPtr window);

    public unsafe static string SDL_GetWindowTitleManaged(IntPtr window)
    {
    ...
    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern int SDL_OpenAudio(ref SDL_AudioSpec desired, SDL_AudioSpec* obtained);

    public static unsafe delegate* unmanaged[Cdecl]<void*, byte*, int> SDL_CreateAudioCallbackFucntionPoiter(SDL_AudioCallback callback)
    {
    ...
    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern void SDL_PauseAudio(bool pause_on);


    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern byte* SDL_GetKeyboardState(int* numkeys);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern byte* SDL_GetError();

    // only SDL_WINDOW_FULLSCREEN, SDL_WINDOW_FULLSCREEN_DESKTOP or 0 works
    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern bool SDL_SetWindowFullscreen(IntPtr window, SDL_WindowFlags flags);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern int SDL_GetDisplayDPI(int displayIndex, float* ddpi, float* hdpi, float* vdpi);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern int SDL_GetWindowDisplayIndex(IntPtr window);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern int SDL_GetNumDisplayModes(int displayIndex);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern int SDL_GetDisplayMode(int displayIndex, int modeIndex, SDL_DisplayMode* mode);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern int SDL_GetCurrentDisplayMode(int displayIndex, SDL_DisplayMode* mode);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern bool SDL_HasClipboardText();

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern char* SDL_GetClipboardText();

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern int SDL_SetClipboardText([MarshalAs(UnmanagedType.LPStr)] string text);

    [DllImport(dll_name, CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
    public static unsafe extern void SDL_free(void* ptr);
    ...
    public static unsafe void SDL_PrintError()
    {
        Console.WriteLine(SDL_GetErrorString());
    }

    public static unsafe string SDL_GetClipboardString()
    {
